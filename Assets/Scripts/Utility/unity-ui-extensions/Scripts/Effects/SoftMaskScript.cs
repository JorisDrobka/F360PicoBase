    ...
    public class SoftMaskScript : MonoBehaviour
    {
        ...
        void SetMaterial()
        {
            if(additive)
            {
                if(!hasAdditiveMat)
                {
                    mat.shader = Shader.Find("UI Extensions/SoftMaskShader Additive");
                    hasAdditiveMat = true;
                }
            }
            else if(!hasAdditiveMat)
            {
                mat.shader = Shader.Find("UI Extensions/SoftMaskShader");
                hasAdditiveMat = false;
            }
        }
