...
namespace F360.Data
{
    ...
    public static class ManeuverUtil
    {
        ...
        static Dictionary<ManeuverType, LookEventType[]> __sequences_unique;

        static ManeuverUtil()
        {
            __maneuverKeys = GetAllTypes().Select(x=> (short)x).ToArray();
            __sequences = new Dictionary<ManeuverType, LookEventType[]>();
            __sequences_unique = new Dictionary<ManeuverType, LookEventType[]>();
            ...
            __sequences_unique.Add(ManeuverType.Vorbeifahren, __sequences[ManeuverType.Vorbeifahren]);
            ...
            __sequences.Add(ManeuverType.Uberholen, 
                            new LookEventType[] { 
                                ...
                                LookEventType.RearViewMirror });
            __sequences_unique.Add(ManeuverType.Uberholen,
                            new LookEventType[] {
                                LookEventType.RearViewMirror,
                                LookEventType.SideMirror_L,
                                LookEventType.SideMirror_R,
            ...
            __sequences_unique.Add(ManeuverType.Spurenwechsel_L, __sequences[ManeuverType.Vorbeifahren]);
            ...
            __sequences.Add(ManeuverType.Spurenwechsel_R, 
                            new LookEventType[] { 
                                ...
                                LookEventType.ShoulderLook_R, 
                                LookEventType.RearViewMirror });
            __sequences_unique.Add(ManeuverType.Spurenwechsel_R, __sequences[ManeuverType.Spurenwechsel_R]);
            ...
            __sequences_unique.Add(ManeuverType.Abbiegen_L, __sequences[ManeuverType.Abbiegen_L]);
            __sequences_unique.Add(ManeuverType.Abbiegen_R, __sequences[ManeuverType.Abbiegen_R]);
        }
        ...
        public static LookEventType[] GetLookSequenceUnique(this ManeuverType type)
        {
            if(!__sequences_unique.ContainsKey(type))
            {
                return new LookEventType[0];
            }
            else
            {
                return __sequences_unique[type];
            }
        }
